...
> **Prefer to see it running first?** [Examples/CsExcel.Examples](../Examples/CsExcel.Examples) is a small console project covering this style, the fluent style, and building a table from a C# type via reflection. Clone the repo and `dotnet run` it directly — see the [README](../README.md#example-project) for details.
